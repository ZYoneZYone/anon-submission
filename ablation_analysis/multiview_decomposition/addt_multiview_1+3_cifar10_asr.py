...
def zero_query_post_train(
    ...
    # ========================================
    # ========================================
    #   weak = T.Compose([T.RandomCrop(32, padding=4)])
...
def build_arg_parser():
    ...
    parser.add_argument("--tau_low", type=float, default=0.88, help="Lower confidence threshold (for weight calculation only)")
    parser.add_argument("--tau_high", type=float, default=0.985, help="Upper confidence threshold (for weight calculation only)")
    parser.add_argument("--n_weak_views", type=int, default=2, help="Number of weak views (NOT USED in this ablation)")
...
def main():
    ...
    print("")
    print("Model selection: Based on best ASR (FGSM, eps=8.0/255.0 for CIFAR-10)")
    print("=" * 120)
