...
def build_arg_parser():
    ...
    parser.add_argument("--tau_low", type=float, default=0.92, help="Lower confidence threshold (for weight calculation only)")
    parser.add_argument("--tau_high", type=float, default=0.99, help="Upper confidence threshold (for weight calculation only)")
    parser.add_argument("--n_weak_views", type=int, default=1, help="Number of weak views (NOT USED in this ablation)")
    parser.add_argument("--alpha_cons", type=float, default=0.22, help="Consistency loss weight")
    return parser
...
def main():
    ...
    print("")
    print("Model selection: Based on best ASR (FGSM, eps=8.0/255.0 for SVHN)")
    print("=" * 120)
