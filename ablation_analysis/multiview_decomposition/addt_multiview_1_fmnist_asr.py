...
def zero_query_post_train(
    ...
    best_asr = float('-inf')
    save_dir = "./ablation_results/multiview_1"
    os.makedirs(save_dir, exist_ok=True)
    save_name = f"multiview_1_{STUDENT_MODEL_NAME}_{TEACHER_MODEL_NAME}_{DATASET}.pth"
    ...
    for epoch in range(epochs):
        ...
        print("-" * 120)
        print(
            f"[Multi-View Base: DGDT + Mix-aug] Epoch {epoch+1}/{epochs} - "
...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Multi-View Decomposition Base (1): DGDT + Mix-augmented")
...
def main():
    ...
    print("=" * 120)
    print("ABLATION STUDY: Multi-View Base: DGDT + Mix-augmented Baseline")
    print("Model selection: Based on best ASR (FGSM)")
    print("=" * 120)
