...
def build_arg_parser():
    ...
    parser.add_argument("--tau_low", type=float, default=0.92, help="Lower confidence threshold")
    parser.add_argument("--tau_high", type=float, default=0.99, help="Upper confidence threshold")
    parser.add_argument("--n_weak_views", type=int, default=1, help="Number of weak views")
    parser.add_argument("--margin_th", type=float, default=0.25, help="Margin threshold")
