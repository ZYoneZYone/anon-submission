...
DATASET = 'fmnist'
TEACHER_WEIGHT_PATH = './target_model_weight/resnet34_fmnist.pth'
STUDENT_WEIGHT_PATH = './baseline/DaST/sub_model_weight/resnet18_resnet34_fmnist.pth'
...
def zero_query_post_train(
    ...
    for epoch in range(epochs):
        ...
        asr = test_robust_with_eval_params(student, teacher, test_loader, 'FGSM', False, 'fmnist')
...
def build_arg_parser():
    ...
    parser.add_argument("--tau_low", type=float, default=0.75, help="Lower confidence threshold for pseudo-label weighting")
    parser.add_argument("--tau_high", type=float, default=0.93, help="Upper confidence threshold for pseudo-label weighting")
    parser.add_argument("--n_weak_views", type=int, default=3, help="Number of weak views for teacher ensembling")
    parser.add_argument("--margin_th", type=float, default=0.06, help="Top1-Top2 margin threshold for selecting pseudo-labels")
    parser.add_argument("--alpha_cons", type=float, default=0.30, help="Weight for consistency loss term")
    return parser
...
def main():
    ...
    print("Model will be saved based on best ASR (FGSM, eps=0.3)")
    print("=" * 100)
