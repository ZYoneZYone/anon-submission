...
DATASET = 'mnist'
TEACHER_WEIGHT_PATH = './target_model_weight/resnet34_mnist.pth'
STUDENT_WEIGHT_PATH = './baseline/DaST/sub_model_weight/resnet18_resnet34_mnist.pth'
...
def zero_query_post_train(
    ...
    for epoch in range(epochs):
        ...
        asr = test_robust_with_eval_params(student, teacher, test_loader, 'FGSM', False, 'mnist')
...
def build_arg_parser():
    ...
    parser.add_argument("--tau_low", type=float, default=0.86, help="Lower confidence threshold for pseudo-label weighting")
    ...
    parser.add_argument("--margin_th", type=float, default=0.18, help="Top1-Top2 margin threshold for selecting pseudo-labels")
    parser.add_argument("--alpha_cons", type=float, default=0.5, help="Weight for consistency loss term")
    return parser
