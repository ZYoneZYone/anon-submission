...
STUDENT_WEIGHT_PATH = './baseline/DFTA/sub_model_weight/resnet18_resnet34_cifar10.pth'
SYNTHETIC_DATASET_PATH = './baseline/DFTA/generated_images' 
...
def resolve_paths(use_advtrained_target: bool):
    ...
    if use_advtrained_target:
        ...
        student_weight_path = os.path.join(
            "./baseline/DFTA/sub_model_weight",
...
def zero_query_post_train(
    ...
    weight_suffix = "_advtrain" if use_advtrained_target else ""
    save_name = f"dfta_addt_zeroquery_asr_{STUDENT_MODEL_NAME}_{TEACHER_MODEL_NAME}_{DATASET}{weight_suffix}.pth"
