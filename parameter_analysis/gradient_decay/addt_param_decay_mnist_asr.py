...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="ADDT Parameter Analysis: Gradient Decay Factor — MNIST")
    parser.add_argument("--tau_low", type=float, default=0.86, help="Lower confidence threshold")
    ...
    parser.add_argument("--margin_th", type=float, default=0.18, help="Margin threshold")
    parser.add_argument("--alpha_cons", type=float, default=0.5, help="Consistency loss weight")
