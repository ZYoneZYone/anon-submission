...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="ADDT Parameter Analysis: Gradient Decay Factor — FMNIST")
    parser.add_argument("--tau_low", type=float, default=0.75, help="Lower confidence threshold")
    parser.add_argument("--tau_high", type=float, default=0.93, help="Upper confidence threshold")
    parser.add_argument("--n_weak_views", type=int, default=3, help="Number of weak views")
    parser.add_argument("--margin_th", type=float, default=0.06, help="Margin threshold")
    parser.add_argument("--alpha_cons", type=float, default=0.30, help="Consistency loss weight")
